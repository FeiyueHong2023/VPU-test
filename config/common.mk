...
export AUDIO_OUTPUT_SW_GAIN := 1
ifeq ($(ANC_ASSIST_ON_DSP),1)
KBUILD_CPPFLAGS += -DANC_ASSIST_ON_DSP
KBUILD_CPPFLAGS += -DANC_ASSIST_TRIGGER_DSP_PROCESS
endif
...
export BLE_APP_DIR_PATH = bthost/service/ble_app
export BLE_AUDIO_APP_DIR_PATH = bthost/service/ble_audio
export BLE_GAF_CORE_DIR_PATH = bthost/service/ble_audio/gaf_core
export BLE_AOB_APP_DIR_PATH = bthost/service/ble_audio/aob_app
export BLE_AUDIO_CORE_DIR_PATH = bthost/service/ble_audio/ble_audio_core
export BLE_AUDIO_TEST_DIR_PATH = bthost/service/ble_audio/ble_audio_test
export BLE_AUDIO_CENTRAL_DIR_PATH = bthost/service/ble_audio/ble_audio_central_app
export BLE_AUDIO_USB_DIR_PATH = bthost/service/ble_audio/ble_audio_central_app/ble_audio_usb
export BLE_AUDIO_I2S_DIR_PATH = bthost/service/ble_audio/ble_audio_central_app/ble_audio_i2s
export BLE_IF_DIR_PATH = bthost/stack/ble_if
export BLE_PROFILES_DIR_PATH = bthost/stack/ble_profiles
...
export AOB_LC3_PLC_DECODER_FREQ_BOOST_ENABLED ?= 0
ifeq ($(AOB_LC3_PLC_DECODER_FREQ_BOOST_ENABLED),1)
KBUILD_CPPFLAGS += -DAOB_LC3_PLC_DECODER_FREQ_BOOST_ENABLED
endif
...
export SEPARATE_THREAD_SEND_ISO_DATA ?= 0
ifeq ($(SEPARATE_THREAD_SEND_ISO_DATA),1)
KBUILD_CPPFLAGS += -D__SEPARATE_THREAD_SEND_ISO_DATA__
endif
...
KBUILD_CPPFLAGS += -DWALKIE_DEVICE_ID_BASE=2
KBUILD_CPPFLAGS += -DWALKIE_DEVICE_MAX=10
endif
...
BLE_PROFILES_INCLUDES += \
    -I$(BLE_PROFILES_DIR_PATH) \
    -I$(BLE_PROFILES_DIR_PATH)/buds/ \
    -I$(BLE_PROFILES_DIR_PATH)/datapath/datapathps/api/ \
    -I$(BLE_PROFILES_DIR_PATH)/gfps/api/ \
    -I$(BLE_PROFILES_DIR_PATH)/gfps/gfps_crypto/ \
    -I$(BLE_PROFILES_DIR_PATH)/gfps/gfps_provider/api/ \
    -I$(BLE_PROFILES_DIR_PATH)/gfps/gfps_provider/src/ \
    -I$(BLE_PROFILES_DIR_PATH)/ota \
    -I$(BLE_PROFILES_DIR_PATH)/tota \
    -I$(BLE_PROFILES_DIR_PATH)/tile
ifeq ($(BLE_AUDIO_ENABLED),1)
BLE_PROFILES_INCLUDES += \
    -I$(BLE_PROFILES_DIR_PATH)/otp/api \
    -I$(BLE_PROFILES_DIR_PATH)/dtp/api \
    -I$(BLE_PROFILES_DIR_PATH)/csip/api
endif
ifeq ($(AMSC),1)
BLE_PROFILES_INCLUDES += \
    -I$(BLE_PROFILES_DIR_PATH)/ams/ \
    -I$(BLE_PROFILES_DIR_PATH)/ams/amsc/ \
...
ifeq ($(ANCC),1)
BLE_PROFILES_INCLUDES += \
    -I$(BLE_PROFILES_DIR_PATH)/anc/ \
    -I$(BLE_PROFILES_DIR_PATH)/anc/ancc/ \
